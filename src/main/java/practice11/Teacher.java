...
public class Teacher extends Person{
    ...
    public void outputAppendMemberSuccess(String studentname,Integer number){
        System.out.print("I am "+name +". I know " + studentname + " has joined Class "+ number +".\n");
    }

    public void outputAssignLeaderSuccess(String studentname,Integer number){
        System.out.print("I am "+name +". I know " + studentname + " become Leader of Class "+ number +".\n");
    }
}
